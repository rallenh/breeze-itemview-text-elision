// qt-style-elide-test-v3.cpp (Qt6)
//
// Additive companion to qt-style-elide-test-v2.cpp. Does NOT replace or modify
...
//
// Build:
//   g++ -o qt-style-elide-test-v3 qt-style-elide-test-v3.cpp $(pkg-config --cflags --libs Qt6Widgets) -fPIC
//
// Run:
//   ./qt-style-elide-test-v3
...
int main(int argc, char *argv[])
{
    ...
    printf("=== SE_ItemViewItemText rect probe v3 (Qt6, slack-aware width sweep) ===\n");
    ...
    printf("Cross-check: the */noWidget rows at 150 and 80 must match probe/qt-style-elide-test-v2's\n");
