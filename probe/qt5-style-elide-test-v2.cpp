// qt5-style-elide-test-v2.cpp (Qt5)
//
// Hardened companion to qt5-style-elide-test.cpp. Does NOT replace or modify
...
//
// Build:
//   g++ -o qt5-style-elide-test-v2 qt5-style-elide-test-v2.cpp $(pkg-config --cflags --libs Qt5Widgets) -fPIC
//
// Run:
//   ./qt5-style-elide-test-v2
...
int main(int argc, char *argv[])
{
    ...
    printf("=== SE_ItemViewItemText rect probe v2 (Qt5, real QListWidget) ===\n");
    ...
    printf("Cross-check: these numbers should match probe/qt5-style-elide-test's\n");
    printf("SE_ItemViewItemText section exactly. Any divergence means opt.widget\n");
    printf("fidelity (bare QWidget vs real QListWidget) matters for this Breeze\n");
    printf("build, and the original probe's numbers should be treated as approximate.\n");
