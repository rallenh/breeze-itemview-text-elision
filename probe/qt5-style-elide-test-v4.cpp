// qt5-style-elide-test-v4.cpp (Qt5)
//
// Additive companion to qt5-style-elide-test-v3.cpp. Does NOT replace or modify
...
//
// Build:
//   g++ -o qt5-style-elide-test-v4 qt5-style-elide-test-v4.cpp $(pkg-config --cflags --libs Qt5Widgets) -fPIC
//
// Run:
//   ./qt5-style-elide-test-v4
...
int main(int argc, char *argv[])
{
    ...
    printf("=== SE_ItemViewItemText rect probe v4 (Qt5, showDecorationSelected isolated) ===\n");
